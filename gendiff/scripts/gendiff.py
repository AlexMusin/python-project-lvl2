...
parser.add_argument('-V', '--version', help='set format output the version number')
args = parser.parse_args()
#print(args.first_file_path)
...
def generate_diff(first_file_path, second_file_path):
    ...
    sorted_keys = sorted(list(set(list(first_file.keys()) + list(second_file.keys()))))
    out_string = '{'
